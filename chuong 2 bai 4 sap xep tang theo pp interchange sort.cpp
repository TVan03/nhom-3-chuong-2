...
void interchangeSortInt(int a[], int n) {
    for (int i = 0; i < n - 1; i++) {
        for (int j = i + 1; j < n; j++) {
            if (a[i] > a[j]) {
                int temp = a[i];
...
void interchangeSortFloat(float a[], int n) {
    for (int i = 0; i < n - 1; i++) {
        for (int j = i + 1; j < n; j++) {
            if (a[i] > a[j]) {
                float temp = a[i];
...
void interchangeSortChar(char a[], int n) {
    for (int i = 0; i < n - 1; i++) {
        for (int j = i + 1; j < n; j++) {
            if (a[i] > a[j]) {
                char temp = a[i];
...
void interchangeSortString(char a[][100], int n) {
    for (int i = 0; i < n - 1; i++) {
        for (int j = i + 1; j < n; j++) {
            if (strcmp(a[i], a[j]) > 0) {
                char temp[100];
...
int main4() {
    ...
    interchangeSortInt(intArr, nInt);
    interchangeSortFloat(floatArr, nFloat);
    interchangeSortChar(charArr, nChar);
    interchangeSortString(stringArr, nString);
